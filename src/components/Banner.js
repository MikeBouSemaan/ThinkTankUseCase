...
export const Banner = () => {
    ...
    const toRotate = ["Innovations Team", "Diverse Team", "Family"];
            ...
            <Container>
                <Row className="align-items-center">
                    <Col xs={12} md={6} xl={7}>
                        ...
                        <h1>{'Hi, We are Think Tank'}</h1>
                        <h1>{'‎'}<span className="wrap">{text}</span></h1>
                        <p>Part of the Supply Chain department at BMW. We solve the hardest challenges related to supply chain and digitalization .</p>
